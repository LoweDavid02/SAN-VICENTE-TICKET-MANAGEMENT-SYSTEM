 ...
 * Preserves all existing ticket result UI and logic
 */
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', paddingTop: 100, paddingBottom: 60, paddingLeft: 24, paddingRight: 24 }}>
          ...
          <h1 style={{
            ...
            Track Your{' '}
            <span style={{ fontStyle: 'italic', color: '#38bdf8' }}>Concern</span>
          </h1>
        ...
        {/* Floating Search Bar */}
        <div style={{ maxWidth: 700, margin: '0 auto', padding: '0 24px', transform: 'translateY(50%)' }}>
          <form
            ...
            <div className="bento-grid">
                        ...
                        return (
                          <div key={idx} className="timeline-item">
                            ...
                            <div className={`timeline-content ${idx > 0 ? 'older' : ''}`}>
                              ...
                              {entry.note && (
                                <p style={{ fontSize: 14, color: '#6B7280', marginBottom: 6, lineHeight: 1.6 }}>{entry.note}</p>
                              )}
                            ...
                            <img
                              ...
                              onError={(e) => {
                                ...
                                e.target.parentElement.innerHTML = `
                                  <div style="width:100%;height:200px;display:flex;align-items:center;justify-content:center;background:#F3F4F6;color:#6B7280;font-size:14px;">
                ...
                {showConfirmation && (
                  <div style={{ background: 'white', borderRadius: 16, padding: 32, border: '1px solid #E5E7EB' }}>
                    ...
                    <div style={{ display: 'flex', gap: 12 }}>
                      ...
                      <button
                        onClick={() => { setShowConfirmation(false); setConfirmationNote(''); }}
                        style={{
                          padding: '12px 24px',
                          borderRadius: 12,
                          border: '1px solid #E5E7EB',
              ...
              <div className="bento-sidebar">
                ...
                <div className="help-card">
                  ...
                  <p style={{ fontSize: 14, marginBottom: 20, lineHeight: 1.6, color: '#FFFFFF' }}>
